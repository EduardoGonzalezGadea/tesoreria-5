...
@Component({
  selector: 'app-cheques-listar-emitidos',
  templateUrl: './cheques-listar-emitidos.component.html',
  styleUrls: ['./cheques-listar-emitidos.component.scss']
})
export class ChequesListarEmitidosComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.chequesService.verEmitidos().subscribe((data: any) => {
